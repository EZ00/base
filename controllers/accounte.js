...
module.exports = function(passport){
  ...
  router.post('/login', function(req,res){
    ...
    if(req.body && req.body.un && req.body.pass){
      if(req.body.un === "ceshi" && req.body.pass === "ceshi"){
        res.send("pass");
      }
      else{
        res.send("No");
    ...
    // fs.writeFile("req.txt",util.inspect(req),function (err) {
    //   if (err) return console.log(err);
    //   console.log('req > req.txt');
    // });
  });
