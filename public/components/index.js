...
/******/ 	__webpack_require__.p = "/public/components/";
	...
	var App = React.createClass({
	  ...
	  renderPropCheckbox: function renderPropCheckbox(prop) {
	    ...
	    return React.createElement(
	      'p',
	      { key: prop },
	      React.createElement('input', { type: 'checkbox', onChange: toggleMethod, checked: this.state[prop], id: prop }),
	      React.createElement(
	        'label',
	        { htmlFor: prop },
	        ' ',
	  ...
	  renderPropNumber: function renderPropNumber(prop) {
	    ...
	    return React.createElement(
	      ...
	      prop,
	      ' ',
	      React.createElement('input', { type: 'number', onChange: setMethod, value: this.state[prop] })
	    );
	  },

	  render: function render() {
	    var sidebar = React.createElement(_sidebar_content2['default'], null);

	    var contentHeader = React.createElement(
	      'span',
	      null,
	      !this.state.docked && React.createElement(
	        'a',
